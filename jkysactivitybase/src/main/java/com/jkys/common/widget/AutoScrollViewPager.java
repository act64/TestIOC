...
public class AutoScrollViewPager extends ViewPager {
    ...
    private boolean hormove=false;

    private class VertricalDestrue extends GestureDetector.SimpleOnGestureListener{
    ...
    private void init() {
        ...
        mGestureDetector=new GestureDetector(getContext(),new VertricalDestrue());
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (!hormove) {
            hormove = mGestureDetector.onTouchEvent(ev);
        }
        if (ev.getAction()== MotionEvent.ACTION_UP){
            hormove=false;
        }
        getParent().requestDisallowInterceptTouchEvent(hormove);
